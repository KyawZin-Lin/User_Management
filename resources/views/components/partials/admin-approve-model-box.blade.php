<div class="modal fade" id="{{"admin-approve-model-$user->id"}}" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url("admin/user/$user->id/approve") }}" method="get">
